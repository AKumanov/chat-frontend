          ...
          <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              ...
              </li>
              {
                !user ? (
                  <li>
                    <Link to="/login" className="block py-2 pr-4 pl-3 text-black md:p-0 dark:text-black">
                      Login
                    </Link>
                  </li>
                ) : (
                  <>
                    ...
                    <button className="block py-2 pr-4 pl-3 text-black md:p-0 dark:text-black" onClick={logout}>
                      Logout
                    </button>
                  </>
                )
